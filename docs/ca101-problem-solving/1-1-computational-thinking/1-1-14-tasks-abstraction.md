...
- hidden details can complicate debugging  
- may reduce transparency of system behaviour  
...
Abstraction tasks are most suitable where complexity must be reduced to focus on essential elements, but may be less appropriate where full visibility of internal processes is required.
