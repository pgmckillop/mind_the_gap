...
ii. need for automation or repeatable processes  
iii. time available for structured analysis  
iv. clarity of requirements  
v. constraints relating to resources and delivery  

Computational thinking is most appropriate where problems must be decomposed, formalised and implemented systematically, but may be less suitable where rapid informal exploration is required.
