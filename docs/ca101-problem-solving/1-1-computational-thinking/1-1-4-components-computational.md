...
- improves focus on core functionality  
- supports clearer communication of designs  
- enables scalable and reusable solutions  

### Drawbacks

- excessive abstraction can hide important detail  
- loss of context may affect accuracy  
...
Algorithmic design involves defining step-by-step instructions to solve problems, ensuring processes are logical, ordered and implementable in code.

### Benefits

- provides clear solution pathways  
- supports automation of processes  
- improves consistency of outputs  
- enables translation into executable programs  

### Drawbacks

- requires precise logic and planning  
- errors in design propagate through solutions  
- may reduce flexibility if overly rigid  
...
iii. need for repeatable and automated processes  
iv. available time and resources  
v. developer experience  

The components of computational thinking are most suitable where structured analysis and systematic solution design are required, but may be less appropriate where rapid informal exploration is needed.
