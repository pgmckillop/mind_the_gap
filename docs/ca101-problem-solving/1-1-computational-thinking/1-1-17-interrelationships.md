...
iii. need for automation and repeatable processes  
iv. time and resource constraints  
v. developer experience  

The combined use of computational thinking components is most suitable where problems require structured analysis and systematic implementation, but may be less appropriate for small or informal tasks where rapid exploration is prioritised.
