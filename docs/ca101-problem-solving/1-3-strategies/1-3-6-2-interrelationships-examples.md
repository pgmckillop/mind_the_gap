...
### Suitable Strategy: Event Tree Analysis (ETA)

### Judgement
**Event Tree Analysis** is suitable because the problem involves **uncertain future outcomes** rather than a known fault. ETA allows different scenarios to be explored, such as successful load handling, partial failure, or complete outage.

This helps the organisation plan contingencies and understand the consequences of different system responses. Root cause analysis techniques would be inappropriate at this stage because no failure has yet occurred.
...
### Suitable Strategy: Combined Approach (Five Whys → FMEA)

### Judgement
Initially, the **Five Whys** can be used to identify the most likely cause of the crashes. Once a cause is suspected, **FMEA** can be used to analyse related failure modes and reduce the risk of future faults.

This combined approach is suitable because the problem is recurring and may have multiple contributing factors. Using a single strategy alone may not fully address the issue.
