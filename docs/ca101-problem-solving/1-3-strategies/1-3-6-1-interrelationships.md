...
This topic is strongly **evaluative**.
...
Problem-solving strategies are chosen **based on these characteristics**.
...
- **Stage of development** (design, implementation, maintenance)

There may be **more than one valid strategy**, but one may be *more suitable* than others.
...
- Recognise limitations of inappropriate strategy selection
