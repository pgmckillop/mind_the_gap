...
To correct errors in an algorithm, structured debugging techniques are used to modify sequence, selection, iteration or data handling so that the algorithm produces the intended output and behaves correctly.
...
**Purpose:**  
to ensure corrections align with the required behaviour.
...
**Purpose:**  
to ensure correct starting values.
...
**Purpose:**  
to ensure correct decision paths are taken.
...
**Purpose:**  
to prevent infinite loops or incorrect repetition.
...
**Purpose:**  
to ensure values change as intended.
...
**Purpose:**  
to confirm that corrections are effective.
...
**Purpose:**  
to verify behaviour step by step.
