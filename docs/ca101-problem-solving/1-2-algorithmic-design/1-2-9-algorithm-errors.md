...
To identify errors in an algorithm, systematic checking and logical reasoning are used to locate mistakes in sequence, selection, iteration or data handling. Errors may affect correctness, efficiency or termination of the algorithm.
...
**Purpose:**  
to detect mismatches between intended and actual behaviour.
...
**Purpose:**  
to expose logical or calculation errors.
...
**Purpose:**  
to ensure conditions evaluate correctly and cover all required cases.
...
**Purpose:**  
to detect infinite loops or incorrect repetition counts.
...
**Purpose:**  
to detect incorrect updates or misuse of values.
...
**Purpose:**  
to ensure all required actions are present and correctly ordered.
...
**Purpose:**  
to visualise execution and isolate faults.
