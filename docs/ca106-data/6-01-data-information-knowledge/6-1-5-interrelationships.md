...
- Each stage is affected by **how the data is generated**

Poor data generation limits the usefulness of resulting information and knowledge.
...
Unsuitable data can lead to incorrect conclusions or decisions.
...
The method used must match the **requirements of the system or analysis**.
...
- Suitable choices improve reliability and effectiveness
- Unsuitable choices increase risk and reduce value
