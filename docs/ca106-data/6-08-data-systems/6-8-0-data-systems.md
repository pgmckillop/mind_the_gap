...
### 6.8.3 Core functions of a data system
...
### 6.8.4 Types of data entry errors

**Data entry errors** occur when incorrect data is entered into a system.

- **Transcription errors**:
  - occur when data is entered incorrectly from a source
- **Transposition errors**:
  - occur when characters or digits are entered in the wrong order

These errors reduce data accuracy and reliability.

!!! tip "Exam tip"
In exams, clearly distinguish between **copying data incorrectly** and **reversing the order of data** to avoid losing marks.

---

### 6.8.5 Methods to avoid data entry errors

Methods to reduce errors include:

- **Validation of user input**:
  - prevents incorrect data entry
- **Verification by double entry**:
  - compares two entries for accuracy
- **Drop-down menus**:
  - limit user input to predefined options
...
### 6.8.6 Factors impacting data entry

Data entry is affected by:

- **Time needed to create screens**:
  - impacts system development effort
- **Expertise needed to create screens**:
  - affects design quality and error prevention
