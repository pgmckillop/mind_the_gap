...
- **Variety**: the range of data formats and types.
- **Variability**: the changeability and inconsistency of data over time.
- **Velocity**: the speed at which data is generated, collected and processed.
- **Veracity**: the accuracy, quality and trustworthiness of data.
- **Value**: the usefulness of data for decision-making and outcomes.
...
**Big Data** refers to datasets that are large, complex and generated rapidly.

- It cannot be effectively handled using traditional data processing methods alone.
- It is characterised by **multiple dimensions**, described by the six Vs.
...
### 6.7.3 Impact of the six Vs on data gathering and maintenance
...
### 6.7.4 Data quality assurance methods
...
### 6.7.5 Factors affecting data maintenance
