...
## Interrelationships between structured data, unstructured data and data type

## Interrelationships

**Structured data**   
is data that is organised into a predefined format, such as tables with rows and columns.  
...
**Unstructured data**
does not follow a predefined data model or structure.  
...
**Data types** 
link structured and unstructured data by determining:  
