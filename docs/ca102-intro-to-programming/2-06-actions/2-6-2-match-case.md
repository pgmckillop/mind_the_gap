...
- 
  ...
  **Purpose:**  
  ...
  - to perform an action only when a specific condition is met.  
  - 
  **Benefits:**  
...
- 
  ...
  **Purpose:**  
  ...
  - to support multiple conditional paths within a decision structure.  
...
-  
  ...
  **Purpose:** 
  - to provide a default outcome when no conditions are met.  
...
-  
  ...
  **Purpose:** 
  - to provide a structured and readable approach to selection when comparing a single value against several possible outcomes.  
