...
- 
  ...
  **Purpose:**  
  ...
  - to perform repetition when the number of iterations is known in advance.  
...
-  
  ...
  **Purpose:** 
  - to perform repetition when the number of iterations depends on a condition evaluated at runtime.  
...
- **Count-controlled `for` loops**  
  ...
  **Purpose:**  
  ...
  - to implement count-controlled iteration clearly and concisely.  
...
- **Condition-controlled `while do` loops**  
  ...
  **Purpose:** 
  - to implement condition-controlled iteration based on runtime evaluation.  
