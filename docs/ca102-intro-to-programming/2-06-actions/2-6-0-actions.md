...
Actions allow programs to respond to different inputs and conditions.
...
These actions form the basis of program control flow.
...
Sequence is used in all programs and underpins all other actions.
...
Selection enables programs to respond differently to different inputs or situations.
...
Iteration is used when actions must occur multiple times based on a condition or count.
