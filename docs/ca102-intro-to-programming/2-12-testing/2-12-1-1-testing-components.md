...
- to identify defects in logic, processing and behaviour before integration.  
...
- to ensure reliability and compatibility before system assembly.  
...
- to ensure data does not cause errors or incorrect results.  
- 
**Benefits:**  
...
**Purpose:**  
-to ensure correct communication between components.  
...
- to confirm that all components work together to meet requirements.  
