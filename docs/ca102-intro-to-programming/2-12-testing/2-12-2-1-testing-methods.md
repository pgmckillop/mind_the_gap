...
- to assess feasibility and suitability at an early stage.  
...
**Purpose:**  
- to verify that each unit functions correctly on its own.  
...
- to identify errors at data boundaries.  
...
- to verify that components work together correctly.  
...
- to assess speed, responsiveness and stability.  
...
**Purpose:**  
-to verify that the full solution meets requirements.  
...
- to determine readiness for release.  
...
- to assess how effectively users can interact with the system.  
...
**Purpose:**  
-to detect unintended side effects of changes.  
...
**Purpose:**  
-to assess reliability and limits of operation.  
...
**Purpose:**  
-to verify internal logic, paths and conditions.  
