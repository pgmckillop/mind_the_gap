...
- 
  ...
  - to identify the most favourable conditions for algorithm performance.  
...
**{==Worst case==}**  
  ...
  **Purpose:**  
  ...
  - to identify performance limits and potential inefficiencies.  
...
**{==Average case==}**  
  ...
  **Purpose:**  
  ...
  - to provide a realistic indication of algorithm behaviour in normal use.  
